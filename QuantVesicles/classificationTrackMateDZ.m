...
%	- aFiltering to long trajectories
...
TMIN = 0.1*CUT;                                 %Minimum time length for evaluation in sec
...
clf
ma2 = ma2.addAll(tracksCUTLL);
ax2 = axis([0 2*pi -1.5 1.5]);
ma2.plotTracks(axes(),20);
%(ax2,1)
%18,178,17,170,160,100,10,90,70,7,1,81,80,50,20
%ma2.plotTracks(ax2,abs(tracksCUT{4,1}(2:1)));
ma2.labelPlotTracks;
axis([-40,40,-40,40]);
...
scatter( L , avgCD, 100, 'r'); %AverageCD vs Length
axis([0,30,0,30]);
